...
*/
function Item(name){
  //this.isThisAName = function(){
    //throw new Error('Not implemented, need new name')
  //}
  this.name = name;
}
...
if (this._pack.length === 3){
  console.log(`${this.name} you're pack is full`)
  return false;
}else{
this._pack.push(item)
console.log(`${this.name}, you were able to store ${item.name}`)
return true;
}
    }
...
if(this._pack.indexOf(item)>=0){
  ...
  console.log(`${this.name} you're ${item.name} was discarded`);
  return true;
}else{
...
this.equip = function(itemToEquip){
  if(!itemToEquip instanceof Weapon){return;}
 if(this.equipped && this._pack.includes(itemToEquip)){
  this._pack.splice(this._pack.indexOf(itemToEquip),1,this.equipped)
  this.equipped = itemToEquip
}else if(!this.equipped && this._pack.includes(itemToEquip)){
  this._pack.splice(this._pack.indexOf(itemToEquip),1,this.equipped)
  this.equipped = itemToEquip;
}
}
this.eat = function(itemToEat){
if(!itemToEat instanceof Food) {return;}
...
* @param {number} speed            The zombie's speed.
*/
function StrongZombie(health, stregnth, speed){
  Zombie.call(this, health, stregnth, speed)
}
...
* @param {number} speed            The zombie's speed.
*/
function RangedZombie(health, stregnth, speed){
  Zombie.call(this, health, stregnth, speed)
}
...
* @param {number} speed            The zombie's speed.
*/
function ExplodingZombie(health, stregnth, speed){
  Zombie.call(this, health, stregnth, speed)
}
